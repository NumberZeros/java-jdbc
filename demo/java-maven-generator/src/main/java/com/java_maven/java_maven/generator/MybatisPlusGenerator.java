package com.java-maven.generator;
...
public class MybatisPlusGenerator {
    ...
    private static final String packageName = "com.java-maven";
    ...
    // 生成的分层代码
    enum LayerType {
        entity("/java-maven-model"),
        mapper("/java-maven-dao"),
        mapperxml("/java-maven-web"),
        service("/java-maven-service"),
        web("/java-maven-web"),
        ;
